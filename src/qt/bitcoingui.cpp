...
void BitcoinGUI::createActions()
{
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mulacoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a mulacoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a Mulacoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Mulacoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Mulacoin"); // default title
