...
public:
    CMainParams() {
        ...
        // Mulacoin: rede nova, zeramos o trabalho mínimo exigido.
        consensus.nMinimumChainWork = uint256S("0x00");

        // By default assume that the signatures in ancestors of this block are valid.
        // Mulacoin: desabilitado para rede nova (sem histórico de blocos confiáveis ainda).
         ...
         */
        pchMessageStart[0] = 0x6d; // "mula" - rede própria da Mulacoin, não colide com Dogecoin/Bitcoin
        ...
        // Genesis block exclusivo da Mulacoin (minerado especificamente para esta chain,
        // não é o genesis do Dogecoin). Ver /home/claude/genesis_miner.py para o script
        // que gerou estes valores.
        {
            const char* pszTimestamp = "Mulacoin - Picanha pro Cumpanheiro - 25/Jun/2026";
            const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
            genesis = CreateGenesisBlock(pszTimestamp, genesisOutputScript, 1782388800, 416965, 0x1e0ffff0, 1, 13 * COIN);
        }

        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0xb98a68840ec1bfa6a91b4765ca03978c808a3fc3b217933f9f352d42d02e4a04"));
        assert(genesis.hashMerkleRoot == uint256S("0x2ae67d6b6a5c09af031226756e71ea0e2d5df55337b4d0081007551d94fec327"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0xb98a68840ec1bfa6a91b4765ca03978c808a3fc3b217933f9f352d42d02e4a04"))
        };

        chainTxData = ChainTxData{
            1782388800, // timestamp do bloco gênese
            0,          // sem transações ainda
            0.0
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        // Mulacoin: desabilitado para rede nova.
        consensus.defaultAssumeValid = uint256S("0x00");
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);   // endereços começam com 'M' (igual ao mainnet, só para consistência nos testes)
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,13);   // endereços P2SH começam com '6'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
